...
public class TxCoreCommonProxy {
	...
	private static final String[] types = new String[] { "Wooden", "Stone", "Iron", "Golden", "Diamond" };
	...
	public static void initItemMaps()
	{
		...
		{
			Item Multi = getItem(String.format("%s MultiTool", name));
			multi.add(Multi);
			items.add(Multi);
			Item pa = getItem(String.format("%s Paxe", name));
			pA.add(pa);
			items.add(pa);
			Item ps = getItem(String.format("%s Picvel", name));
			pS.add(ps);
			items.add(ps);
			Item psa = getItem(String.format("%s Paxel", name));
			pSA.add(psa);
			items.add(psa);
			Item pssw = getItem(String.format("%s Piverd", name));
			pSSw.add(pssw);
			items.add(pssw);
			Item psw = getItem(String.format("%s Picord", name));
			pSw.add(psw);
			items.add(psw);
			Item pswa = getItem(String.format("%s Paxerd", name));
			pSwA.add(pswa);
			items.add(pswa);
			Item sa = getItem(String.format("%s Shaxe", name));
			sA.add(sa);
			items.add(sa);
			Item ssw = getItem(String.format("%s Shord", name));
			sSw.add(ssw);
			items.add(ssw);
			Item sswa = getItem(String.format("%s Swaxel", name));
			sSwA.add(sswa);
			items.add(sswa);
			Item swa = getItem(String.format("%s Swaxe", name));
			swA.add(swa);
			items.add(swa);
		}
